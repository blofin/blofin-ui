...
export const DisabledTextColor = cva("", {
  variants: {
    theme: {
...
export const Cell = cva("", {
  variants: {
    theme: {
      light:
        "[&:has([aria-selected])]:bu-text-light-second [&:has([aria-selected].day-outside)]:!bu-bg-light-background [&:has([disabled])]:bu-bg-light-line-primary",
...
export const DaySelected = cva("", {
  variants: {
    theme: {
      light:
        "bu-bg-light-primary hover:bu-bg-light-primary hover:bu-text-light-second focus:bu-bg-light-primary focus:bu-text-light-second",
