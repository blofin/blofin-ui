import { c as t, j as n, a as i } from "./index-1069cba6.js";
import "react";
const s = (g) => {
  const a = {
    dark: {
  ...
  return t("rounded px-[10px] py-[5px] text-[12px]", {
    variants: {
      color: {
        primary: a[r].primary,
  ...
  decoration: r = !0,
  label: e
}) => /* @__PURE__ */ n.jsxs("span", { className: `${i(s({ theme: g, color: a }))}`, children: [
  r && "• ",
  e
] });
export {
